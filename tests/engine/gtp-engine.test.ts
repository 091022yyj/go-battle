  ...
  send(data: string) {
    ...
    setTimeout(() => {
      ...
      if (msg.cmd === 'name') {
        ...
        response = JSON.stringify({ id: msg.id, ok: true, response: 'info move e16 visits 100 winrate 0.6 scoreLead 2.5\ninfo move d16 visits 80 winrate 0.55 scoreLead 1.2' })
